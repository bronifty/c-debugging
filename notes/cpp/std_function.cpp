...
// No capture, no parameters
    ...
    print_num(f2(9));  // Now properly calls print_num with the result

    // Capture by reference
    multiplier = 10;  // Just reassign, don't redeclare
    auto f3 = [&multiplier](int x) { multiplier = x; return x; };  // Added return value
    print_num(f3(9));
